...
function [hAxes] = plot_figures3(x,y1,y2,y3,xlim0,xlim1,ylim0,ylim1,label1,label2,legend1,legend2,legend3,fig_name)
%plot function for three y variables and one x variable. The plot is set to a
...
plot(hAxes, x,y1,'LineStyle', '-', 'Color', [50/256 50/256 50/256],... %grey
    'LineWidth', 1);
plot(hAxes, x,y2,'LineStyle', '-', 'Color', [230/256 25/256 75/256],... %reddish
    'LineWidth', 1);
plot(hAxes, x,y3,'LineStyle', '-', 'Color', [0/256 130/256 200/256],...%blueish
     'LineWidth', 1);
...
hLegend=legend(hAxes, legend1, legend2,legend3);
